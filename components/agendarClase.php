<section class="section agendar" id="agendar-clase">
    ...
    <div class="agendar-center reveal">
            ...
            <form id="agendar-form" class="agendar-form">
                <div class="grid-form">
                    ...
                    <div class="experiencia">
                        <label for="experiencia">¿Cómo te sientes bailando actualmente?</label>
                        <select name="experiencia" id="experiencia">
                            <option value="" selected disabled>Selecciona una opción...</option>
                            <option value="Es mi primera vez bailando"> Es mi primera vez bailando ✨</option>
                            <option value="He bailado un poco en fiestas"> He bailado un poco en fiestas 🎉</option>
                            <option value="Ya he tomado clases antes"> Ya he tomado clases antes 🕺</option>
                            <option value="Tengo experiencia y quiero mejorar"> Tengo experiencia y quiero mejorar 🔥
                            </option>
                        </select>
                    </div>
                    <div class="">
                ...
                <p class="cta-agendar">Te responderemos lo antes posible 🎉</p>
            </form>
        </div>
    </div>
</section>